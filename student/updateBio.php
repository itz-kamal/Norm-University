<?php
	...
	if ($currentStuMatNo != "" && $currentStuPas != "") {
		...
		if (isset($_POST['submit'])) {
			$kin = htmlentities($_POST['nextOfKin']);
			$kinAddress = htmlentities($_POST['kinAddress']);
			$guadianMobile = htmlentities($_POST['sponsorMobile']);
			//update datas
			$updateDatas = mysqli_query($db_conx, "UPDATE other_reg SET nextOfKin='$kin', addressKin='$kinAddress', sponsorMobile='$guadianMobile' WHERE matricNo='$currentStuMatNo' ");
			if ($updateDatas) {
		...
		<div class="floatL RSPSSSec">
			...
			<div style="margin: 10px 20px;"><?php echo $report; ?></div>
				...
				<div class="UPCon">
					...
					<span class="UPANot"><input type="text" class="fillData" name="nextOfKin" value="<?php echo $kin; ?>"></span>
				</div>
				<div class="UPCon">
					<span class="UPLabel">Address of Next of Kin :</span>
					<span class="UPANot"><input type="text" class="fillData" name="kinAddress" value="<?php echo $kinAddress; ?>"></span>
				</div>
				<div class="UPCon">
					<span class="UPLabel">Guadian Telephone Number :</span>
					<span class="UPANot"><input type="text" class="fillData" name="sponsorMobile" value="<?php echo $sponsorMobile; ?>"></span>
				</div>
				<div class="UPCon">
					<span class="UPLabel">Name of Guadian :</span>
