...
<html>
<head>
	<title>Norm university student page</title>
...
<body>
	...
	<div class="SPMcontent">
		<div class="HTag">Students</div>
		<div class="NSec floatL FS90">
			<div class="SPHead">Academic Resources</div>
			<a href="javascript: window.open('student/signIn.php');" class="SPLink">Students Portal</a>
			<a href="javascript: window.open('student/signUp.php')" class="SPLink">New Student</a>
			...
			<div class="SPLink">Graduate Announcement</div>
			<div class="SPLink BTLine"></div>
			<div class="SPHead">Related Links</div>
			<a class="SPLink">Events Calender</a>
			<div class="SPLink">Upcoming Webniars</div>
			<div class="SPLink BTLine">Students Researches</div>
			<div class="SPHead">Student Events</div>
